...
import { createAddtvaudio } from '../store/action/action'
...
class Selltvaudioform extends React.Component {
    ...
    handleSubmit = (e) => {
        e.preventDefault();
        this.props.createAddtvaudio(this.state)
                                    ...
                                    <div className="category-space p-5 m-4">
                                        <div className="row" style={{ borderBottomStyle: "groove", borderBottomWidth: "2px" }}>
                                            <div className="col-sm-12 px-4 py-4">
                                                ...
                                                <br></br>
                                                <i>TV-Audio-Video</i>&nbsp;&nbsp;<Link to="/sell" className="text-black-50">Change</Link>
                                            </div>
                                        </div>
                                        <div className="row py-3" style={{ borderBottomStyle: "groove", borderBottomWidth: "2px" }}>
                                            <div className="col-sm-10">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <select required onChange={this.handleChange} className="form-control" id="category">
                                                        ...
                                                        <option>Other Home Appliances</option>
                                                        <option>Generator,UPS & Power Solutions</option>
                                                        <option>Kitchen Appliances</option>
                                                        <option>AC & Coolers</option>
                                                        <option>Fridges & Freezers</option>
...
const mapDispatchToProps = (dispatch) => {
    return {
        createAddtvaudio: (adm) => dispatch(createAddtvaudio(adm))
    }
}

export default connect(mapStateToProps, mapDispatchToProps)(Selltvaudioform);