...
import { createAddcar } from '../store/action/action'
...
class Sellcarform extends React.Component {
    ...
    handleSubmit = (e) => {
        e.preventDefault();
        this.props.createAddcar(this.state)
                                    ...
                                    <div className="category-space p-5 m-4">
                                        <div className="row" style={{ borderBottomStyle: "groove", borderBottomWidth: "2px" }}>
                                            <div className="col-sm-12 px-4 py-4">
                                                ...
                                                <br></br>
                                                <i>Cars</i>&nbsp;&nbsp;<Link to="/sell" className="text-black-50">Change</Link>
                                            </div>
                                        </div>
                                            ...
                                            <div className="col-sm-10">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <select onChange={this.handleChange} required className="form-control" id="category">
                                                        ...
                                                        <option>Bus ,Vans and Trucks</option>
                                                        <option>Rikshaw & Chingchi</option>
                                                        <option>Other Vehicles</option>
                                                        <option>Boats</option>
                                                        <option>Tractors & Trailors</option>
                                                    </select>
...
const mapDispatchToProps = (dispatch) => {
    return {
        createAddcar: (adm) => dispatch(createAddcar(adm))
    }
}
