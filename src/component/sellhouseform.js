...
import { createAddhouse } from '../store/action/action'
...
class Sellhouseform extends React.Component {
    ...
    handleSubmit = (e) => {
        e.preventDefault();
        this.props.createAddhouse(this.state)
                                    ...
                                    <div className="category-space p-5 m-4">
                                        <div className="row" style={{ borderBottomStyle: "groove", borderBottomWidth: "2px" }}>
                                            <div className="col-sm-12 px-4 py-4">
                                                ...
                                                <br></br>
                                                <i>Houses</i>&nbsp;&nbsp;<Link to="/sell" className="text-black-50">Change</Link>
                                            </div>
                                        </div>
                                            ...
                                            <div className="col-sm-10">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <select required onChange={this.handleChange} className="form-control" id="category">
                                                        ...
                                                        <option>Appartment & Flats</option>
                                                        <option>Shops-Offices-Commercial Space</option>
                                                        <option>Portions & Floors</option>
                                                    </select>
                                                </div>
...
const mapDispatchToProps = (dispatch) => {
    return {
        createAddhouse: (adm) => dispatch(createAddhouse(adm))
    }
}

export default connect(mapStateToProps, mapDispatchToProps)(Sellhouseform);