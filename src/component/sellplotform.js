...
import { createAddplot } from '../store/action/action'
...
class Sellplotform extends React.Component {
    ...
    handleSubmit = (e) => {
        e.preventDefault();
        this.props.createAddplot(this.state)
                                    ...
                                    <div className="category-space p-5 m-4">
                                        <div className="row" style={{ borderBottomStyle: "groove", borderBottomWidth: "2px" }}>
                                            <div className="col-sm-12 px-4 py-4">
                                                ...
                                                <br></br>
                                                <i>Land & Plots</i>&nbsp;&nbsp;<Link to="/sell" className="text-black-50">Change</Link>
                                            </div>
                                        </div>
...
const mapDispatchToProps = (dispatch) => {
    return {
        createAddplot: (adm) => dispatch(createAddplot(adm))
    }
}

export default connect(mapStateToProps, mapDispatchToProps)(Sellplotform);